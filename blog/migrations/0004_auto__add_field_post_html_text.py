...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.html_text'
        db.add_column(u'blog_post', 'html_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.html_text'
        db.delete_column(u'blog_post', 'html_text')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'html_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
